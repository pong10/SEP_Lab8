...
class Simple_drawing_window(QWidget):
    ...
    def paintEvent(self, e):
        ...
        p.drawPolygon([QPoint(0, 85), QPoint(75, 75), QPoint(100, 10), QPoint(125, 75), QPoint(200, 85),
                       QPoint(150, 125), QPoint(160, 190), QPoint(100, 150), QPoint(40, 190), QPoint(50, 125),
                       QPoint(0, 85), ])

        p.setPen(QColor(164, 244, 66))
        p.setBrush(QColor(164, 244, 66))
        p.drawPolygon([QPoint(100, 50), QPoint(50, 150), QPoint(150, 150), ])

        # Pong

        p.drawPixmap(QRect(360, 150, 330, 300), self.rabbit)
        p.end()
